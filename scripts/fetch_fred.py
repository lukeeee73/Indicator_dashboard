...
STOCKS: dict[str, dict] = {
    ...
    # ── 반도체 — AI 칩 · 설계 ─────────────────────────────────────
    "NVDA":     {"name": "NVIDIA Corporation",       "sector": "Technology", "group": "반도체 — AI 칩 · 설계"},
    "AMD":      {"name": "Advanced Micro Devices",   "sector": "Technology", "group": "반도체 — AI 칩 · 설계"},
    "INTC":     {"name": "Intel Corporation",        "sector": "Technology", "group": "반도체 — AI 칩 · 설계"},
    "QCOM":     {"name": "QUALCOMM Incorporated",    "sector": "Technology", "group": "반도체 — AI 칩 · 설계"},
    "AVGO":     {"name": "Broadcom Inc.",            "sector": "Technology", "group": "반도체 — AI 칩 · 설계"},
    "MRVL":     {"name": "Marvell Technology, Inc.", "sector": "Technology", "group": "반도체 — AI 칩 · 설계"},
    "2454.TW":  {"name": "MediaTek Inc.",            "sector": "Technology", "group": "반도체 — AI 칩 · 설계"},
    "MBLY":     {"name": "Mobileye Global Inc.",     "sector": "Technology", "group": "반도체 — AI 칩 · 설계"},
    "SNPS":     {"name": "Synopsys, Inc.",           "sector": "Technology", "group": "반도체 — AI 칩 · 설계"},
    "CDNS":     {"name": "Cadence Design Systems",   "sector": "Technology", "group": "반도체 — AI 칩 · 설계"},
    "ARM":      {"name": "Arm Holdings plc",         "sector": "Technology", "group": "반도체 — AI 칩 · 설계"},
    # ── 반도체 — 메모리 (HBM·DRAM) ─────────────────────────────────────
    "005930.KS":  {"name": "Samsung Electronics",     "sector": "Technology", "group": "반도체 — 메모리 (HBM·DRAM)"},
    "000660.KS":  {"name": "SK Hynix",                "sector": "Technology", "group": "반도체 — 메모리 (HBM·DRAM)"},
    "MU":         {"name": "Micron Technology, Inc.", "sector": "Technology", "group": "반도체 — 메모리 (HBM·DRAM)"},
    # ── 반도체 — 파운드리 · 패키징 · 기판 ─────────────────────────────────────
    "TSM":     {"name": "Taiwan Semiconductor Mfg.", "sector": "Technology", "group": "반도체 — 파운드리 · 패키징 · 기판"},
    "AMKR":    {"name": "Amkor Technology, Inc.",    "sector": "Technology", "group": "반도체 — 파운드리 · 패키징 · 기판"},
    "4062.T":  {"name": "Ibiden Co., Ltd.",          "sector": "Technology", "group": "반도체 — 파운드리 · 패키징 · 기판"},
    # ── 반도체 — 장비 · 소재 ─────────────────────────────────────
    "ASML":       {"name": "ASML Holding N.V.",           "sector": "Technology", "group": "반도체 — 장비 · 소재"},
    "AMAT":       {"name": "Applied Materials, Inc.",     "sector": "Technology", "group": "반도체 — 장비 · 소재"},
    "LRCX":       {"name": "Lam Research Corp.",          "sector": "Technology", "group": "반도체 — 장비 · 소재"},
    "TOELY":      {"name": "Tokyo Electron Limited",      "sector": "Technology", "group": "반도체 — 장비 · 소재"},
    "KLAC":       {"name": "KLA Corporation",             "sector": "Technology", "group": "반도체 — 장비 · 소재"},
    "042700.KS":  {"name": "Hanmi Semiconductor",         "sector": "Technology", "group": "반도체 — 장비 · 소재"},
    "6857.T":     {"name": "Advantest Corporation",       "sector": "Technology", "group": "반도체 — 장비 · 소재"},
    "6146.T":     {"name": "DISCO Corporation",           "sector": "Technology", "group": "반도체 — 장비 · 소재"},
    "BESI.AS":    {"name": "BE Semiconductor Industries", "sector": "Technology", "group": "반도체 — 장비 · 소재"},
    "4063.T":     {"name": "Shin-Etsu Chemical",          "sector": "Materials",  "group": "반도체 — 장비 · 소재"},
    # ── AI 인프라 — 네트워킹 · 광 · 네오클라우드 ─────────────────────────────────────
    "ANET":  {"name": "Arista Networks, Inc.",    "sector": "Technology", "group": "AI 인프라 — 네트워킹 · 광 · 네오클라우드"},
    "COHR":  {"name": "Coherent Corp.",           "sector": "Technology", "group": "AI 인프라 — 네트워킹 · 광 · 네오클라우드"},
    "MPWR":  {"name": "Monolithic Power Systems", "sector": "Technology", "group": "AI 인프라 — 네트워킹 · 광 · 네오클라우드"},
    "CRWV":  {"name": "CoreWeave, Inc.",          "sector": "Technology", "group": "AI 인프라 — 네트워킹 · 광 · 네오클라우드"},
    "NBIS":  {"name": "Nebius Group N.V.",        "sector": "Technology", "group": "AI 인프라 — 네트워킹 · 광 · 네오클라우드"},
    # ── 로보틱스 / 피지컬 AI ─────────────────────────────────────
    ...
    "6954.T":  {"name": "FANUC Corporation",      "sector": "Industrials", "group": "로보틱스 / 피지컬 AI"},
    "6324.T":  {"name": "Harmonic Drive Systems", "sector": "Industrials", "group": "로보틱스 / 피지컬 AI"},
    # ── 자동차 / 모빌리티 ─────────────────────────────────────
